...
export const requestResetEmail = async (req, res, next) => {
  ...
  const html = template({
    name: user.username,
    link: `${process.env.FRONTEND_DOMAIN}/reset-password?token=${encodeURIComponent(resetToken)}`,
  });

  console.log('[reset] link =', `${process.env.FRONTEND_DOMAIN}/reset-password?token=${encodeURIComponent(resetToken)}`);
